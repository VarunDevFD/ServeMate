      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Security Deposit: ₹${item.sdPrice}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Location: ${item.location.join(', ')}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Description: ${item.description}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Condition: ${item.condition}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Storage: ${item.storage?.join(', ') ?? 'N/A'}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Connectivity: ${item.connectivity?.join(', ') ?? 'N/A'}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Duration: ${item.duration}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Late Policy: ${item.latePolicy}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Phone Number: ${item.phoneNumber}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Available: ${item.available ? 'Yes' : 'No'}',
                style: TextStyle(fontSize: 16.sp)),
            Text(
                'Privacy Policy: ${item.privacyPolicy ? 'Accepted' : 'Not Accepted'}',
                style: TextStyle(fontSize: 16.sp)),
            Text('Permission: ${item.permission ?? 'N/A'}',
                style: TextStyle(fontSize: 16.sp)),
          ],
        ),
      ),
