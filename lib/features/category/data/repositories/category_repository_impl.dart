...
class CategoryRepositoryImpl implements CategoryRepository {
  ...
  final List<Category> categories = [
    const Category(
        name: 'Cameras', imageUrl: 'assets/images/category/cameras.jpg'),
    const Category(
        name: 'Decoration', imageUrl: 'assets/images/category/decoration.jpg'),
    const Category(
        name: 'Dresses', imageUrl: 'assets/images/category/dresses.jpg'),
    const Category(
        name: 'FootWear', imageUrl: 'assets/images/category/footwear.jpg'),
    const Category(
        name: 'Jewelry', imageUrl: 'assets/images/category/jewelry.jpg'),
    const Category(
        name: 'Sound & DJ Systems',
        imageUrl: 'assets/images/category/sound&dj.jpg'),
    const Category(
        name: 'Vehicles', imageUrl: 'assets/images/category/vehicles.jpg'),
    const Category(
        name: 'Venue', imageUrl: 'assets/images/category/venues.jpg'),
  ];
